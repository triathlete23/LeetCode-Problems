...
namespace Tests
{
    ...
    public class SortsShould
    {
        ...
        {
            CustomNode node2 = new CustomNode(null, null, 2);
            CustomNode node6 = new CustomNode(null, null, 6);
            CustomNode node5 = new CustomNode(node2, node6, 5);
            CustomNode node8 = new CustomNode(null, null, 8);
            CustomNode node7 = new CustomNode(node5, node8, 8);
            CustomNode node16 = new CustomNode(null, null, 16);
            CustomNode node17 = new CustomNode(node16, null, 17);
            CustomNode node13 = new CustomNode(null, node17, 13);
            CustomNode node9 = new CustomNode(node7, node13, 9);

            var res = node9.Find(8);
